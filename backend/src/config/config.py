...
class BasicSettings(BaseSettings, case_sensitive=True):
    model_config = SettingsConfigDict(env_file=env_files, env_file_encoding='utf-8', extra="ignore", env_prefix='basic_')
...
class OpenAiSettings(BaseSettings, case_sensitive=False):
    model_config = SettingsConfigDict(env_file=env_files, env_file_encoding='utf-8',extra="ignore",  env_prefix='openai_')
...
class VectorStoreSettings(BaseSettings, case_sensitive=False):
    model_config = SettingsConfigDict(env_file=env_files, env_file_encoding='utf-8',extra="ignore", env_prefix='vs_')
...
class EmbeddingSettings(BaseSettings, case_sensitive=False):
    model_config = SettingsConfigDict(env_file=env_files, env_file_encoding='utf-8', extra="ignore", env_prefix='embedding_')

    provider: str = "openai"  # openai or  local


class LocalAiSettings(BaseSettings, case_sensitive=False):
    model_config = SettingsConfigDict(env_file=env_files, env_file_encoding='utf-8', extra="ignore", env_prefix='local_ai_')
